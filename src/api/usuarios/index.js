...
router.delete('/usuarios/:id', passport.authenticate('bearer', {session: false}), servicoUsuario.delete);

router.put('/usuarios/:id', passport.authenticate('bearer', {session: false}), servicoUsuario.alterarUsuario);
